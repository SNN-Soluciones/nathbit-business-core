...
public class ProductoDTO {
    ...
    public static ProductoDTO fromEntity(Producto entity) {
        ...
        return ProductoDTO.builder()
                ...
                .tipoInventario(entity.getTipoInventario().name())
                .zonaPreparacion(entity.getZonaPreparacion().name())
                ...
                .moneda(entity.getMoneda().name())
                .unidadMedidaCompra(entity.getUnidadMedidaCompra().name())
                .unidadMedidaUso(entity.getUnidadMedidaUso().name())
